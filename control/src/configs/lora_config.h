...
#if defined(CONFIG_AWAY_SENDER) || defined(CONFIG_HOME_RECEIVER)  // No
                                                                  // crosstalk
...
#define INTER_PACKET_DELAY_TICKS \
  (pdMS_TO_TICKS(50))  // small delay between packets to avoid flooding
